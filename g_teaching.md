...
- Statistical Foundations and Visualization for V&V
- Computational Techniques for Simulation Model V&V
- Verification and Validation of Agent-Based Models: From Rule-Based to Generative Agents
- Human-Centered and Societal Validation
- From Synthetic Populations to AI Respondents: Methods and Validation
- Machine Learning Validation: Evaluation Design and Model Selection
- Robustness, Reproducibility, and Monitoring of ML Systems
- Large Language Models: Evaluation and Trustworthiness
- Adversarial and Misaligned AI: Validation of Generative and Agentic Systems
- Validation of Statistical and Probabilistic Models
- Ethics, Governance, and Model Assurance
...
- Complexity in Human-Environment Systems
- Design Considerations in Spatial Agent-Based Modeling
- Model Communication Protocols and Ontologies
- ABM/GIS Integration
- Applications: Agrarian Societies
- Applications: Urban Models and Gentrification
- Applications: Slums and Urban Poverty
- Applications: Residential Land Markets
- Applications: Mobile Agent Models
...
I was the course coordinator and instructor for the Modeling and Simulation 1 (CDS 230) course at George Mason University. In this course, students learned basic modeling and simulation concepts and got familiar with Python. The course website was located at [http://hamdikavak.com/course-modsim-1/](http://hamdikavak.com/course-modsim-1/). You can still watch the welcome video below to learn more about this course.
